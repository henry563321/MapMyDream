...
ActiveRecord::Schema.define(version: 20170828200412) do
  ...
  create_table "friends", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["apply_user_id", "user_id"], name: "index_friends_on_apply_user_id_and_user_id", unique: true, using: :btree
  ...
  create_table "routes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["route"], name: "index_routes_on_route", using: :btree
